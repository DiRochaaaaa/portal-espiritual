  ...
  return (
    <main style={styles.container}>
      ...
      <div style={styles.contentContainer}>
        ...
        >
                    {!showVideo && (            <>              <motion.button                style={styles.button}                whileHover={{                   scale: 1.05,                   background: 'linear-gradient(to right, #D4AF37, #FFD700)'                }}                whileTap={{ scale: 0.95 }}                onClick={handleStartReading}              >                {t.startReading}              </motion.button>                            <motion.div                initial={{ opacity: 0, y: 20 }}                animate={{ opacity: 1, y: 0 }}                transition={{ delay: 0.8, duration: 0.5 }}                style={{ marginTop: '1.5rem', textAlign: 'center' }}              >                <Link                   href="/login"                  style={{                    display: 'inline-flex',                    alignItems: 'center',                    gap: '0.5rem',                    padding: '0.75rem 1.5rem',                    background: 'rgba(123, 31, 162, 0.3)',                    color: 'rgba(255, 255, 255, 0.9)',                    border: '1px solid rgba(123, 31, 162, 0.5)',                    borderRadius: '24px',                    textDecoration: 'none',                    fontSize: '0.875rem',                    fontWeight: '500',                    transition: 'all 0.3s ease',                    boxShadow: '0 2px 8px rgba(0, 0, 0, 0.2)',                  }}                  onMouseEnter={(e) => {                    e.currentTarget.style.background = 'rgba(123, 31, 162, 0.6)';                    e.currentTarget.style.color = '#D4AF37';                    e.currentTarget.style.borderColor = 'rgba(212, 175, 55, 0.5)';                  }}                  onMouseLeave={(e) => {                    e.currentTarget.style.background = 'rgba(123, 31, 162, 0.3)';                    e.currentTarget.style.color = 'rgba(255, 255, 255, 0.9)';                    e.currentTarget.style.borderColor = 'rgba(123, 31, 162, 0.5)';                  }}                >                  <svg                     width="16"                     height="16"                     viewBox="0 0 24 24"                     fill="none"                     stroke="currentColor"                     strokeWidth="2"                  >                    <path d="M9 12l2 2 4-4"/>                    <path d="M21 12c-1 0-3-1-3-3s2-3 3-3 3 1 3 3-2 3-3 3"/>                    <path d="M3 12c1 0 3-1 3-3s-2-3-3-3-3 1-3 3 2 3 3 3"/>                    <path d="M12 3v18"/>                  </svg>                  Acessar Portal                </Link>              </motion.div>            </>          )}
